...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public String[] DUMMY_CREDENTIALS = new String[]{
            "acondesa:acondesa", "acondesa:acondesa"
    };
    /**
       ...
       // @Override
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                DUMMY_CREDENTIALS = new String[]{ja.getString(1) + ":" + ja.getString(7)};
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError("Ingrese solo numeros");
            focusView = mEmailView;
            cancel = true;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                //Intent MainActivity2 = new Intent(getApplicationContext(), jesu.acondesa_servicio_al_cliente.RecyclerViewActivity.class);
